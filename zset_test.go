...
func TestIncrBy(t *testing.T) {
	...
	rank, score, _ := z.GetRank(int64(1050), false)
	curScore, _ := z.IncrBy(1.5, int64(1050))
	if score+1.5 != curScore {
		t.Errorf("score = %v, curScore = %v", score, curScore)
	}
	r2, score2, _ := z.GetRank(int64(1050), false)
	if score2 != curScore {
		t.Fail()
	}
	if r2 != rank+1 {
...
func TestRange(t *testing.T) {
	z := New(Int64)
	z.Set(1.0, int64(1001), nil)
	z.Set(2.0, int64(1002), nil)
	z.Set(3.0, int64(1003), nil)
	z.Set(4.0, int64(1004), nil)
	z.Set(5.0, int64(1005), nil)
	z.Set(6.0, int64(1006), nil)

	ids := make([]int64, 0, 6)
	z.Range(0, -1, func(score float64, k interface{}, _ interface{}) {
	...
	z.RevRange(1, 3, func(score float64, k interface{}, _ interface{}) {
		t.Log(score, k)
	})
...
func (d *data) Set(key, val interface{}) {
	d.m[key] = val
}
